...
export default function Home() {
  ...
  return (
    <div className={`${playfair.className}`}>
      ...
      <div className="w-full h-[60vh] relative">
        ...
        />
        <div
          className={`${playfair.className} top-[30%] text-center w-full absolute text-white text-7xl font-bold`}
        >
          Contact us
          <div className="w-[15%] ml-auto mr-auto h-[15px] bg-blue-800 rounded-full mt-7"></div>
        </div>
      </div>
      ...
      <div className="w-full px-10 bg-amber-50 py-16 flex flex-col">
        ...
        <div className="w-[90%] ml-auto mr-auto flex flex-row justify-between">
          <form
          ...
          >
            ...
            <div className="flex flex-row justify-between mt-6">
              ...
              <input
                type="email"
                id="email"
                className="w-[45%] text-black font-normal border-b-2 border-b-black focus:outline-none placeholder:text-black placeholder:text-xl"
                placeholder="mail"
              />
            </div>
  ...
  {faqs.map((faq, index) => {
    ...
    return (
      <div
        key={index}
        className={`border-b border-b-black rounded-t-[8px] overflow-hidden
        }`}
      >
        <button
