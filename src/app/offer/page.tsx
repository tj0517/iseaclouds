        ...
        index % 2 === 0 ? (
          <div key={index}>
            ...
            <div className="w-full flex flex-col md:flex-row md:bg-gray-400">
              <div
                className="w-full md:w-[60%] h-[60vh] relative"
              ...
              >
                ...
                <motion.ul
                  className="list-none sm:list-disc pl-6 space-y-1 mt-10 sm:mt-20 md:mt-5 lg:mt-10 italic xl:text-[16px] text-[13px] mb-10 md:mb-0 text-center sm:text-left "
                  initial="hidden"
                  whileInView="visible"
                  viewport={{ once: true }}
                  variants={{
            ...
            {offers[index + 1] && (
              <div className="w-full flex flex-col md:flex-row bg-amber-50">
                <div
                  className="w-full md:w-[60%] h-[60vh] relative order-1 md:order-2"
