...
<h1 className=" text-blue-500 lg:text-blue-800 w-full lg:w-[70%] text-center lg:text-left text-5xl sm:text-6xl lg:text-4xl xl:text-5xl 2xl:w-[75%] font-bold lg:mt-16 mt-24">
...
<div className="p-4 bg-blue-800 text-white w-[40%] ml-[30%] lg:ml-0 mt-12 lg:mt-20 text-center rounded-full" >Explore</div>
<div className="w-[40%] lg:w-[20%] ml-[30%] lg:ml-0 flex flex-row justify-between text-3xl lg:text-2xl xl:text-3xl text-white mt-[70px] lg:mt-[100px]">
...
<div className="w-[50%] xl:w-[40%] h-[60vh] md:h-[75vh] relative xl:ml-[2.5%] mt-18 md:mt-0">
  <Image
    src="/engineer1.jpg"
    alt="Logo"
    fill
...
<div className="w-[100%] px-[5%] flex flex-row bg-gray-400 pt-3 pb-9 justify-between  text-6xl lg:text-7xl xl:text-8xl  font-bold text-blue-800">
<div  className="w-25%  text-center">
<div className={`${playfair.className} text-blue-800  font-bold`}>
25
</div>
<div className=" text-white text-xl lg:text-2xl mt-7 font-light" >
Years of experience
</div>  
</div>
<div  className="w-25%  text-center">
...
</div><div  className="w-25%  text-center font-light">
<div className={`${playfair.className}`}>
550
</div>
<div className=" text-white text-xl lg:text-2xl mt-7 font-light" >
...
<div className="w-full xl:px-30 px-20 py-30 flex lg:flex-row flex-col justify-between">
<div className={`${poppins.className} flex-col w-[80%] ml-auto mr-auto lg:w-[40%] text-center lg:text-left`}>
<div className="xl:text-5xl text-4xl text-blue-800 font-bold">Master Offshore Skills with SeaClouds Courses</div>
<div className=" text-[16px] 2xl:text-xl text-black font-light xl:mt-10 mt-6 2xl:leading-10 w-[80%] lg:w-full ml-[10%] lg:ml-0">
...
<div className="w-[80%] lg:w-[50%] ml-[10%] lg:ml-0 xl:w-[42.5%] flex flex-row justify-between flex-wrap h-full mt-20 lg:mt-0">
...
<div className="w-[100%] px-[5%] flex flex-row flex-wrap pb-9 justify-between mt-30 xl:text-[16px] text-[14px]">
<div className=" w-[40%] lg:w-[20%] flex flex-col text-center mb-20 lg:mb-0">
<div className={`${playfair.className} text-black xl:text-4xl text-3xl font-bold pb-7 border-b-2`}>Offshore<br></br>Engineering</div>
...
<div className="w-[40%] lg:w-[20%] flex flex-col text-center mb-20 lg:mb-0">
<div className={`${playfair.className} text-black xl:text-4xl text-3xl font-bold pb-7 border-b-2`}>Flexible<br></br>
Service</div>
...
<div className={`${playfair.className} text-black xl:text-4xl text-3xl font-bold pb-7 border-b-2`}>Quality <br></br>
Safety</div>
...
<div className="w-[40%] lg:w-[20%] flex flex-col text-center">
<div className={`${playfair.className} text-black xl:text-4xl text-3xl font-bold pb-7 border-b-2`}>Long-term<br></br> Collaboration</div>
