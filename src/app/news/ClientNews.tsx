  ...
  return (
    <div className="overflow-x-hidden bg-amber-50">
      ...
      <div className="w-full flex flex-row relative">
        <div className="bg-cyan-900 w-[40%]" />
        <div className="w-[60%] h-[45vh] sm:h-[65vh] relative">
          <Image
        ...
        >
          ...
          <div className={`${playfair.className} sm:text-blue-800 text-black text-xl sm:text-2xl xl:text-3xl font-bold mt-3`}>
            {articles[0].title}
          </div>
            ...
            >
              <div className="w-full md:w-[75%] md:ml-[12.5%] flex flex-row justify-around md:justify-normal md:flex-col">
                ...
                <div className="flex flex-col w-[40%] md:w-full">
                  ...
                  <div className={`${playfair.className} text-black text-xl sm:text-2xl md:text-2xl xl:text-3xl font-bold mt-3 w-full sm:w-[90%] xl:w-[75%]`}>
                    {article.title}
                  </div>
